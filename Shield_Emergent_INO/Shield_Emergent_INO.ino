...
//  pinMode(Button4, INPUT_PULLUP);// 4 Rpi Pico pull_up must be after the attachinterrupt. It's a bug.
  ...
  attachInterrupt(digitalPinToInterrupt(nFLT1), Fault1, LOW);
  attachInterrupt(digitalPinToInterrupt(nFLT2), Fault2, LOW);
  pinMode(nFLT1, INPUT_PULLUP);// 4 Rpi Pico pull_up must be after the attachinterrupt. It's a bug.
  pinMode(nFLT2, INPUT_PULLUP);// 4 Rpi Pico pull_up must be after the attachinterrupt. It's a bug.
